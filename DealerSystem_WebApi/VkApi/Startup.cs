...
using System.Text;
using BaseLayer.Logger;
using BaseLayer.Token;
using DataLayer.Context;
using DataLayer.Repository;
using DataLayer.Repository.Interfaces;
using OperationLayer;
using OperationLayer.Mapper;
using OperationLayer.Validation;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "DealerSystem Api Management", Version = "v1.0" });
...

    {
        ...
        if (env.IsDevelopment())
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DealerSystem"));
        }
